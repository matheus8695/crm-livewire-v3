...
it('should not load the livewire component on production environment', function () {
    ...
    get(route('dashboard'))->assertDontSeeLivewire('dev.login');
    get(route('login'))->assertDontSeeLivewire('dev.login');
});
...
it('should load the livewire component on non production environments', function () {
    ...
    get(route('dashboard'))->assertSeeLivewire('dev.login');
    get(route('login'))->assertSeeLivewire('dev.login');
});
